  ...
  return (
    <div className="bg-white w-full ">
      <div className=" w-full p-5 py-0  lg:pr-0 ">
        <div
          className={`w-full  grid lg:grid-cols-2 gap-10 ${
