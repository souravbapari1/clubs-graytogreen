...
function AboutAndJoin() {
  return (
    <div className="bg-white w-full ">
      <div className=" w-full p-5 py-0 md:p-10 lg:pr-0 ">
        <div className="w-full grid lg:grid-cols-2 gap-10 pr-0 py-10">
          <div className="w-[86%] flex flex-col justify-center items-start">
            <h1 className="text-[36px] font-light text-[#336940]">
              Growing Green Minds: Empowering Sustainability for a Better
              Tomorrow
            </h1>
            <p className="mt-5 text-[#727970] w-[80%] text-[16px] font-light leading-[21px]">
          ...
          <div className="w-full  md:h-[80vh] flex justify-end items-center px-0 py-6 pt-12 relative">
            ...
            <div className="md:max-w-[400px] w-full md:h-auto  h-auto bg-[#336940B2]/70 border border-[#336940B2]/20 lg:backdrop-blur-3xl backdrop-blur-lg  absolute 2xl:right-[600px] lg:right-[380px] right-0 lg:left-auto left-0 mx-auto rounded-3xl md:rounded-b-3xl md:bottom-auto bottom-0 rounded-b-none p-8">
